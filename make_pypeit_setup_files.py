...
parser.add_argument('-b', '--band',default = 'IR')  
parser.add_argument('--no_limit',
                    action='store_true')  # remove separation limit on telluric
